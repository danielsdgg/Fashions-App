...
const About = () => {
  ...
  return (
    <>
      <Navbar />
      <section className="bg-gray-400 py-28" data-aos="fade-up">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {/* First team member */}
            <div className="col-span-3 md:col-span-1 pt-9" data-aos="fade-right">
            ...
            {/* Second team member */}
            <div className="col-span-3 md:col-span-1 pt-9" data-aos="fade-up">
              <div className="bg-gray-100 rounded-lg p-8 transition-colors duration-300 hover:bg-blue-500 hover:text-white">
            ...
            {/* Third team member */}
            <div className="col-span-3 md:col-span-1 pt-9" data-aos="fade-left">
              <div className="bg-gray-100 rounded-lg p-8 transition-colors duration-300 hover:bg-blue-500 hover:text-white">
